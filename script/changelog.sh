...
EOF
for i in "feat:Added" "chore:Minor Changes" "test:Test" "docs:Documentation" "bug:Fixed" "refactor:Changed" "remove:Removed" "deprecate:Deprecated" "security:Security" "ci:CI"; do
    TYPE=${i%%:*}
    TITLE=${i#*:}
